...
const Hero = () => {
  return (
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between w-full max-w-285 gap-10 lg:gap-0 py-16 lg:py-0 text-center lg:text-left">
        
        <div className="w-full lg:max-w-120.25 flex flex-col items-center lg:items-start">
          ...
          <Button
            className="mt-8 py-[12.5px] px-5 mx-auto  lg:mx-0 bg-[#1D1F26] font-semibold text-base leading-[100%] text-white hover:text-[#1D1F26] hover:bg-white border border-transparent hover:border-[#1d1f26] rounded-xl"
        ...
        <div className="w-full  lg:max-w-103">
          <Form
            ...
            textareaCss={
              "h-[131px] px-4 py-3 bg-[#f9f9f9] rounded-[12px] w-full resize-none"
            }
            fields={[
            ...
            btcss={
              "bg-[#EF7D00] hover:bg-white hover:text-[#ef7d00] border font-semibold text-base leading-[100%] border-transparent hover:border-[#ef7d00] py-[13.5px] w-full rounded-[12px] text-white"
            }
          />
        </div>
